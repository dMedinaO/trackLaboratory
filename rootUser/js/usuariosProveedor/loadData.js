...
$(window).on('load', function() {
    ...
    //listamos los datos...
	    ...
	    var t = $('#usersData').DataTable({
	        ...
	        "dom": '<"newtoolbar">frtip',
					...
					"ajax":{
						"method":"POST",
						"url": "../php/usuariosProveedor/showData.php"
					},
	...
	var eliminar = function(){
		$("#eliminar-usuario").on("click", function(){
			...
			$.ajax({
				method:"POST",
				url: "../php/usuariosProveedor/removeData.php",
				data: {
						"idusuario": idusuario
					  }
			}).done( function( info ){
	...
	var editar = function(){
		$("#editar-usuario").on("click", function(){
			...
			$.ajax({
				method: "POST",
				url: "../php/usuariosProveedor/editData.php",
				data: {
					"name"   : name,
	...
	var guardar = function(){
		$("#agregar-usuario").on("click", function(){
			...
			$.ajax({
				method: "POST",
				url: "../php/usuariosProveedor/addData.php",
				data: {
						"name"   : name,
						"emailUsuario"   : emailUsuario,
						"proveedor"   : proveedor,
